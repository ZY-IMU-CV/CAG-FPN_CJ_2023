...
class SoftRoIExtractor(nn.Module):
    ...
    def __init__(self,
        ...
        self.spatial_attention_conv = nn.Sequential(nn.Conv2d(out_channels * len(featmap_strides), out_channels, 1),
                                                    nn.ReLU(),
                                                    nn.Conv2d(out_channels, len(featmap_strides), 3, padding=1))
